                    ...
                    <div className="flex h-full flex-col overflow-y-scroll bg-white py-6 shadow-xl">
                      <div className="px-4 sm:px-6">
                        <div className="flex items-start justify-between">
                          ...
                          <div className="ml-3 flex h-7 items-center">
                            <button
                              type="button"
                              className="relative rounded-md bg-white text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-bynlegreen-500 focus:ring-offset-2"
                      ...
                      <div className="relative mt-6 flex-1">
                        ...
                        <form onSubmit={createTicketScanner}>
                          ...
                          <button
                            type="submit"
                            className="mx-5 rounded-md bg-bynlegreen-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-bynlegreen-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-bynlegreen-600"
                          >
                            Add Scanner
                          </button>
                        </form>
                                    ...
                                    <li className="mt-2">
                                      ...
                                      >
                                        <input
                                          ...
                                          name="newpassword"
                                          id="newpassword"
                                          className="col-span-3 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-bynlegreen-600 sm:text-sm sm:leading-6"
                                          required
                                        />
                                        <button
                                          onClick={() =>
    ...
    <div className="px-4 sm:px-6 lg:px-8">
      ...
      <div className="sm:flex sm:items-center">
        ...
        <div className="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
          <button
            type="button"
            className="block rounded-md bg-bynlegreen-600 px-3 py-2 text-center text-sm font-semibold text-white shadow-sm hover:bg-bynlegreen-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-bynlegreen-600"
          >
            Create Event
          </button>
        </div>
