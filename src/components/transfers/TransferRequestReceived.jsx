...
function TransferRequestReceived() {
  ...
  // Example frontend code for accepting transfer requests
          ...
          >
            <div className="relative flex flex-1 flex-col p-8">
              <div
                ...
                style={{
                  backgroundImage: `url(${request.event_cover})`,
                }}
              />
...
export default TransferRequestReceived;
